...
public class SuperResponse implements org.apache.thrift.TBase<SuperResponse, SuperResponse._Fields>, java.io.Serializable, Cloneable, Comparable<SuperResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SuperResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new SuperResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SuperResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SuperResponse.class, metaDataMap);
  }
   ...
   */
  public SuperResponse(SuperResponse other) {
  ...
  public SuperResponse deepCopy() {
    return new SuperResponse(this);
  }
  ...
  public SuperResponse setStatus(int status) {
    this.status = status;
    setStatusIsSet(true);
    return this;
  }
  ...
  public SuperResponse setHeaders(Map<String,String> headers) {
    this.headers = headers;
    return this;
  }
  ...
  public SuperResponse setBody(byte[] body) {
    this.body = body == null ? (ByteBuffer)null : ByteBuffer.wrap(Arrays.copyOf(body, body.length));
    return this;
  }

  public SuperResponse setBody(ByteBuffer body) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SuperResponse)
      return this.equals((SuperResponse)that);
    return false;
  }

  public boolean equals(SuperResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(SuperResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SuperResponse(");
    boolean first = true;
  ...
  private static class SuperResponseStandardSchemeFactory implements SchemeFactory {
    public SuperResponseStandardScheme getScheme() {
      return new SuperResponseStandardScheme();
    }
  }

  private static class SuperResponseStandardScheme extends StandardScheme<SuperResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SuperResponse struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SuperResponse struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class SuperResponseTupleSchemeFactory implements SchemeFactory {
    public SuperResponseTupleScheme getScheme() {
      return new SuperResponseTupleScheme();
    }
  }

  private static class SuperResponseTupleScheme extends TupleScheme<SuperResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SuperResponse struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SuperResponse struct) throws org.apache.thrift.TException {
